  ...
  const row = new MessageActionRow()
    ...
    collector.on("collect", (reaction, user) => {
      if (reaction.customId === "클래식") {
        ...
        int.editReply({embeds: [equipment], components: [] })
        collector.stop()
      } else if (reaction.customId === "고스트") {
        let equipment = new MessageEmbed()
            .setColor("BLUE")
